...
sealed class Route(
    ...
    object ListaDeProducoesRoute : Route("lista-producoess")
    object AdicionarQtHorariaRoute : Route("adicionar-qthoraria")
    ...
    object AtualizarProducaoRoute : Route("atualizar_producao/{producaoId}") {
